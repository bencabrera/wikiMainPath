#include "articleNetworkHandler.h"
...
namespace WikiMainPath {
	...
	void ArticleNetworkHandler::handleRequest(Poco::Net::HTTPServerRequest& request, Poco::Net::HTTPServerResponse& response)
	{
		...
		Graph subgraph = _article_network.create_subgraph(_category_has_article[category_id].begin(), _category_has_article[category_id].end());
