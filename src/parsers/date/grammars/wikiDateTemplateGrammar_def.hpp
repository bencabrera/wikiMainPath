...
namespace WikiMainPath {
	...
	template<typename Iterator, typename Skipper>
		WikiDateTemplateGrammar<Iterator, Skipper>::WikiDateTemplateGrammar() : WikiDateTemplateGrammar::base_type(start, "WikiDateTemplateGrammar") {
			...
			old_new_labels = "age","age nts", "birth date", "birth-date", "birthdate", "death date", "start date", "end date", "start date and age", "birth date and age", "film date", "start date and years ago";
